...
public class Shortcuts {
    ...
    public static void click(String image, String click, double confidence, int timeoutSeconds){
        Point matchPoint;
        try{
            matchPoint = Functions.waitForTarget(image, confidence, timeoutSeconds);
            if (matchPoint != null) {
